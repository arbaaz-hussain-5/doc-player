...
import { AuthenticationFailedError, PasswordHashingError } from "../errors/auth.error.js";
...
async function checkThePassword(password: string, hashedPassword: string): Promise<boolean> {
  try {
...
export { verifyAuthentication, createAutheticationToken, hashThePassword, checkThePassword };
